(function () {
  ...
  const PUBLIC_PROFILE_PATH = `/api/public/profile/${PERSON_ID}?sections=profile`;
  ...
  const STATIC_PROFILE_DATA = {
    ...
    public_profile_context: {
      public_insight: "อาจารย์ นักวิจัย กรรมการสภามหาวิทยาลัยเกษตรศาสตร์ และผู้ทำงานด้าน AI การศึกษา การพัฒนาคน และระบบข้อมูลเพื่อการตัดสินใจ",
    },
  };
  const MANUAL_ADMIN_TIMELINE = [
    "พ.ย. 2567 - สิงหาคม 2572 กรรมการสภามหาวิทยาลัยเกษตรศาสตร์ ประเภทคณาจารย์ประจำ",
  ];
